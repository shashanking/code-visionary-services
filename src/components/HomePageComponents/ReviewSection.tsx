...
const ReviewSection: React.FC<{ initialData?: ReviewItem[] }> = ({ initialData }) => {
  ...
  const { reviewItems: rawReviewItems, loading, error } = useSanityTopRatedLatestReviews(8, 4, initialData);
