...
const ContactForm: React.FC = () => {
  ...
  return (
    <ContentContainer
      maxWidth="7xl"
      paddingX="none"
      className="relative w-full rounded-[22px] overflow-hidden p-[2px] bg-gradient-to-r from-[#2B7EE0] to-[#B5442C] flex justify-center items-center"
    >
      <div
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="block font-sans text-body2 font-medium text-[#161616] mb-1 text-left">
                        Full Name <span className="text-[#B5442C]">*</span>
                      </label>
                      <input
                        type="text"
                        value={userName}
                    ...
                    <div>
                      <label className="block font-sans text-body2 font-medium text-[#161616] mb-1 text-left">
                        Email Address <span className="text-[#B5442C]">*</span>
                      </label>
                      <input
                        type="email"
                        value={userEmail}
                ...
                <div className="w-full text-center py-4">
                  ...
                  <div className="mb-4">
                    <p className="text-[#161616] font-sans text-body2 text-center md:text-left">
                      ...
                      development. <strong>Please contact us directly</strong>{" "}
                      to schedule your call using the information{" "}
                  ...
                  <div className="bg-yellow-50 rounded-lg p-4 mb-4 border border-yellow-200">
                    ...
                    <p className="text-[#161616] font-sans text-body2 mt-2">
                      Please mention this preferred time when you contact us.
                    </p>
                  </div>

                  <p className="text-[#161616] font-sans text-body2 mt-4">
                    We apologize for the inconvenience. Online scheduling will
                    be available soon!
                  </p>
                </div>
              )}
