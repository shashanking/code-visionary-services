...
import type { SanityBaseContent } from "../../types/portfolio-data";
import { urlFor } from "../../lib/sanityClient";
import ContentContainer from "../shared/ContentContainer";

interface PortfolioContentSectionProps {
...
const PortfolioContentSection: React.FC<PortfolioContentSectionProps> = ({ content }) => {
