...
interface HeroPortfolioDetailsPageProps {
    portfolio: PortfolioItemDetails;
}

const HeroPortfolioDetailsPage: React.FC<HeroPortfolioDetailsPageProps> = ({ portfolio }) => {
    return (
                ...
                <div className="flex flex-row items-center gap-3">
                    ...
                    <div className="flex flex-row items-center gap-3">
                        ...
                        <span className="font-montserrat font-normal text-base text-transparent bg-clip-text bg-gradient-to-l from-[#4F1E13] to-[#B5442C]">
                            {new Date(portfolio.date).toLocaleDateString("en-GB", {
                                day: "numeric",
                                month: "short",
                                year: "numeric",
                            })}
